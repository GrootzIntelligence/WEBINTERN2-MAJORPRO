        ...
        <section className="fixed-footer py-2 sm:py-2 lg:py-2">
            <div className="px-2 mx-auto sm:px-4 lg:px-6 max-w-7xl flex items-center justify-between">
                <div className="footer-links flex items-center space-x-3">
                    ...
                    <a href={facebook_link} title="Facebook" className="flex items-center justify-center">
                        <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M13.397 20.997v-8.196h2.765l.411-3.209h-3.176V7.548c0-.926.258-1.56 1.587-1.56h1.684V3.127A22.336 22.336 0 0 0 14.201 3c-2.444 0-4.122 1.492-4.122 4.231v2.355H7.332v3.209h2.753v8.202h3.312z"></path>
                        </svg>
                    </a>
                    <a href={insta_link} title="Instagram" className="flex items-center justify-center">
                        <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                ...
                <p className="footer-text">© Copyright 2024, All Rights Reserved by Grootz</p>
            </div>
        </section>
    );
}
